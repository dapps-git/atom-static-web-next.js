                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp} className="space-y-4 text-gray-700 leading-relaxed">
                            ...
                            <p>
                                Our commitment to holistic education has helped countless students secure seats in Indias top institutions and renowned universities, shaping confident individuals who lead with integrity and knowledge.
                            </p>
                            <p>
