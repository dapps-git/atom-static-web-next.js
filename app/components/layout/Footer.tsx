    ...
    const Footer = () => {
        ...
        const socialLinks = [
            {
            icon: FaFacebookF,
            href: "https://www.facebook.com/people/Atom-Institute-of-Science/61586810271838/",
            label: "Facebook",
            },
            {
            icon: FaInstagram,
            href: "https://www.instagram.com/atom_valanchery/",
            label: "Instagram",
            },
            {
            icon: FaYoutube,
            href: "https://www.youtube.com/@atomValanchery",
            label: "YouTube",
            },
            {
            icon: FaLinkedinIn,
            href: "https://www.linkedin.com/in/atom-institute-of-science",
            label: "LinkedIn",
            },
        ];
